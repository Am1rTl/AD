    ...
    [19], {
        ...
        580: function(t, r, e) {
            ...
            var n = e(514),
                ...
                h = (e(101), {
                    layout: function(t) {
                        return t.$auth.$state.loggedIn ? "default" : "guest"
                    },
                    head: {
                        title: "Send Form"
                    },
                    components: {
                        SimpleForm: e(503).default
                    },
                    data: function() {
                        return {
                            formData: {
                    ...
                    methods: {
                        submitForm: function(data) {
                            var t = this;
                            return this.$axios.$post("/forms/".concat(this.$route.params.id), data).then((function(r) {
                                t.success = r._id
                            }))
                        }
                    },
                        ...
                        return Object(v.a)(regeneratorRuntime.mark((function r() {
                            ...
                            return regeneratorRuntime.wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    case 0:
                                        return e = t.$axios, n = t.params, r.next = 3, e.$get("/forms/".concat(n.id));
                                    case 3:
                ...
                component = Object(_.a)(h, (function() {
                    ...
                    return r(m.a, {
                    ...
                    }, [r("h1", [t._v('Submit form "' + t._s(t.form.title) + '"')]), t._v(" "), t.success ? r(n.a, {
                        staticClass: "mt-10",
                        attrs: {
                            type: "success"
                        }
                    }, [t._v("\n    Form sended. (ID: " + t._s(t.success) + ")"), r("br"), t._v("\n    Thank you!\n  ")]) : r("SimpleForm", {
                        attrs: {
                            submitText: "Submit",
                            submitForm: t.submitForm,
                            formData: t.formData
                        }
                    }, t._l(t.form.inputs, (function(input, e) {
                        return r(m.a, {
                            key: "field_".concat(e)
                        }, ["textarea" == input.type ? r(d.a, {
                            attrs: {
                                label: input.name
                            },
                            model: {
                                value: t.formData.inputs[input.name],
                                callback: function(r) {
                                    t.$set(t.formData.inputs, input.name, r)
                                },
                                expression: "formData.inputs[input.name]"
                            }
                        }) : "checkbox" == input.type ? r(o.a, {
                            attrs: {
                                label: input.name
                            },
                            model: {
                        ...
                        }, t._l(input.settings.options, (function(option, i) {
                            return r(l.a, {
                                key: "radio_".concat(i),
                                attrs: {
                                    label: option,
