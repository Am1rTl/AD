...
function Register() {
    ...
    var register = AuthContext_1.useAuth().register;
    var _a = react_1.useState({ name: '', email: '', password: '' }), formData = _a[0], setFormData = _a[1];
    ...
    return (React.createElement("div", { className: "min-h-[80vh] flex items-center justify-center relative" },
        ...
        React.createElement("div", { className: "card max-w-md w-full p-8" },
            React.createElement("div", { className: "text-center mb-8" },
                React.createElement(fa_1.FaTree, { className: "text-5xl text-emerald-600 mx-auto mb-4" }),
                React.createElement("h1", { className: "festive-header justify-center" }, "Join the Celebration!"),
                React.createElement("p", { className: "text-emerald-600 mt-2" }, "Create your account to start planning holiday events")),
            error && (React.createElement("div", { className: "bg-red-50 text-red-800 p-3 rounded-md mb-4 text-sm" }, error)),
            React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                React.createElement("div", { className: "relative" },
                    React.createElement("label", { className: "block text-sm font-medium text-emerald-800 mb-1" }, "Full Name"),
                    React.createElement("div", { className: "relative" },
                        React.createElement("input", { type: "text", className: "input pl-10", value: formData.name, onChange: function (e) { return setFormData(__assign(__assign({}, formData), { name: e.target.value })); }, required: true }),
                        React.createElement(fa_1.FaUser, { className: "absolute left-3 top-1/2 -translate-y-1/2 text-emerald-500" }))),
                React.createElement("div", { className: "relative" },
                ...
                React.createElement("button", { type: "submit", className: "btn btn-primary w-full group" },
                    React.createElement("span", { className: "group-hover:scale-105 transition-transform inline-flex items-center gap-2" },
                        React.createElement(fa_1.FaSnowflake, { className: "text-white" }),
                        "Create Account"))),
            React.createElement("div", { className: "mt-6 text-center" },
                ...
                ' ',
                React.createElement(react_router_dom_1.Link, { to: "/login", className: "text-emerald-600 hover:text-emerald-700 font-medium" }, "Sign In")))));
}
